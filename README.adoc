...
(Currently broken. See issue https://github.com/asciidoctor/asciidoctor-epub3/issues/47[#47]).
...
We *strongy* recommend that you transfer the file to your device using other means, such as a USB cable or sync service like Dropbox.
